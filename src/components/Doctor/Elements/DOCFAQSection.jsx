...
const DOCFAQSection = () => {
  ...
  const faqData = [
    {
      question: 'How can I Allow slot booking?',
      answer: [
        'You have to click the "Allow slot booking" button on the website.', 
        'You can then book the slot on the website.',
        'Select your tiem at your conveniense.',
